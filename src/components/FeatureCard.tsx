    ...
    >
      ...
      {expanded && (
        <div className={`px-4 pb-4 sm:px-5 sm:pb-5 rounded-b-xl ${defaultExpanded ? '' : 'border-t border-gray-100 border-l border-l-emerald-200'}`}>
          ...
          {/* Observations */}
          <div className="mt-4">
            <h4 className="text-sm font-medium text-gray-700 mb-2">{t('featureCard.observations')}</h4>
          ...
          {hasAdditionalMeasurements && (
            <div className="mt-4">
              <h4 className="text-sm font-medium text-gray-700 mb-2">{t('featureCard.extraMeasurements')}</h4>
