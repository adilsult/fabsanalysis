...
const MEASUREMENT_INFO_EN: Record<string, MeasurementMeta> = {
  rightArchAngle: { label: 'Arch Angle (right)', description: 'Angle of the right eyebrow arch in degrees, measured at the highest point. Norm: 120–160°. Calculated from three key brow landmarks.' },
  leftArchAngle: { label: 'Arch Angle (left)', description: 'Left eyebrow arch angle in degrees. Measured similarly to the right. Norm: 120–160°.' },
  ...
  rightLengthProxy: { label: 'Brow Length (right)', description: 'Right eyebrow length relative to face height. Distance from inner to outer edge divided by face height.' },
  leftLengthProxy: { label: 'Brow Length (left)', description: 'Left eyebrow length relative to face height. Same as right side.' },
  ...
  rightEAR: { label: 'Eye Openness (right)', description: 'Eye Aspect Ratio — vertical/horizontal ratio of the eye opening. Norm: 0.18–0.42. Low = narrow eye, high = wide open.' },
  leftEAR: { label: 'Eye Openness (left)', description: 'Same metric for the left eye. Comparison with right gives symmetry info. Norm: 0.18–0.42.' },
  ...
  rightWidthRatio: { label: 'Eye Width (right)', description: 'Horizontal size of the right eye opening relative to interpupillary distance.' },
  leftWidthRatio: { label: 'Eye Width (left)', description: 'Horizontal size of the left eye opening relative to interpupillary distance.' },
